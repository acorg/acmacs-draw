...
namespace acmacs::surface
{
    class Surface
    {
      public:
        ...
        [[noreturn]] Surface(const Surface&) : mOriginInParent(PointCoordinates::with_nan_coordinates_2D) { throw std::runtime_error("Surface copying forbidden!"); } // cannto make it private due to using vector<SurfaceCairoChild>
        virtual ~Surface()
        {
        }

...
acmacs::Viewport geographic_map_viewport()
{
    ...
    return {acmacs::PointCoordinates(geographic_map_bounds[0], -geographic_map_bounds[1]), acmacs::PointCoordinates(geographic_map_bounds[2], -geographic_map_bounds[3])};

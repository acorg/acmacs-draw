...
PYBIND11_MODULE(acmacs_draw_backend, m)
{
    ...
    py::class_<acmacs::surface::Surface>(m, "Surface")
            ...
            .def("circle_filled_p", [](Surface& aSurface, double x, double y, double diameter, std::string outline_color, double width, std::string fill_color, double aspect, double rotation) { aSurface.circle_filled({x, y}, Pixels{diameter}, Aspect{aspect}, Rotation{rotation}, Color(outline_color), Pixels{width}, acmacs::surface::Dash::NoDash, Color(fill_color)); }, py::arg("x"), py::arg("y"), py::arg("diameter"), py::arg("outline_color"), py::arg("width"), py::arg("fill_color"), py::arg("aspect") = 1.0, py::arg("rotation") = 0.0)
            .def("circle_filled_s", [](Surface& aSurface, double x, double y, double diameter, std::string outline_color, double width, std::string fill_color, double aspect, double rotation) { aSurface.circle_filled({x, y}, Scaled{diameter}, Aspect{aspect}, Rotation{rotation}, Color(outline_color), Pixels{width}, acmacs::surface::Dash::NoDash, Color(fill_color)); }, py::arg("x"), py::arg("y"), py::arg("diameter"), py::arg("outline_color"), py::arg("width"), py::arg("fill_color"), py::arg("aspect") = 1.0, py::arg("rotation") = 0.0)
